...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    _gsScope._gsDefine("TweenMax", [
        ...
        l.updateTo = function (a, b) {
            ...
            b && e._startTime < e._timeline._time && (
        ...
        l.render = function (a, b, d) {
            ...
            if (
                a >= q - h && a >= 0
                    ...
                    : h > a
                        ? (
                            ...
                            a > -h
                                ? a = 0
                                : 0 > a && (p._active = !1, 0 === u && (p._initted || !p.vars.lazy || d) && (
                                    v >= 0 && (d = !0),
                                    p._rawPrevTime = n = !b || a || v === a
                                        ? a
                                        : h
                        ...
                        : (
                            ...
                            0 !== p._repeat && (
                                ...
                                p._yoyo && 0 !== (1 & p._cycle) && (p._time = u - p._time, o = p._yoyoEase || p.vars.yoyoEase, o && (
                                    p._yoyoEase || (
                                        o !== !0 || p._initted
                                            ? p._yoyoEase = o = o === !0
                                                ? p._ease
                ...
                return void(
                    s !== p._totalTime && p._onUpdate && (b || p._callback("onUpdate"))
                );
            if (!p._initted) {
                ...
                !p._time || e || o
                    ? e && this._ease._calcEnd && !o && (p.ratio = p._ease.getRatio(
                        0 === p._time
                            ? 0
                            : 1
                    ))
            ...
            for (
                ...
                0 === s && (2 === p._initted && a > 0 && p._init(), p._startAt && (
                    a >= 0
        ...
        g.staggerTo = g.allTo = function (a, b, h, i, l, n, o) {
            ...
            for (
                ...
                for (s in h) 
                    q[s] = h[s];
                if (
                    v && (e(q, a, r), null != q.duration && (b = q.duration, delete q.duration)),
                    w
                ) {
                    w = q.startAt = {};
                    for (s in h.startAt) 
                ...
                r === p && l && (q.onComplete = function () {
                    h.onComplete && h
                        .onComplete
                        .apply(h.onCompleteScope || this, arguments),
        ...
        var p = function (a, c, d, e) {
            ...
            for (var f, g, h = o(e), i = c && d && e, j = h.length; --j > -1;) 
                g = h[j],
                (i || g instanceof b || (f = g.target === g.vars.onComplete) && d || c && !f) && g.paused(
                    a
                )
        };
            ...
            return arguments.length
                ? this.totalTime(this.duration() * (
                    this._yoyo && 0 !== (1 & this._cycle)
                        ? 1 - a
                        : a
                ) + this._cycle * (this._duration + this._repeatDelay), b)
                : this.duration()
    ...
    _gsScope._gsDefine("TimelineLite", [
        ...
        var d = function (a) {
                ...
                for (d in f) 
                    ...
                    i(c) && -1 !== c
                        .join("")
                        .indexOf("{self}") && (f[d] = e._swapSelfInParams(c));
        ...
        s
            .kill()
            ._gc = s._forcingPlayhead = s._hasPause = !1,
            ...
            if (
                ...
                if (e instanceof Array || e && e.push && i(e)) {
                    for (g = g || "normal", h = h || 0, j = f, k = e.length, l = 0; k > l; l++) 
                        ...
                        p.add(m, j),
                        "string" != typeof m && "function" != typeof m && (
                            "sequence" === g
                ...
                if ("function" != typeof e) 
                    throw "Cannot add " + e + " into the timeline; it is not a tween, timeline, fun" +
                            "ction, or string.";
                e = c.delayedCall(0, e)
            }
            if (
        ...
        s.render = function (a, b, c) {
            ...
            if (
                ...
                if (a > p) 
                    for (d = o._first; d && d._startTime <= a && !l;) 
                        d._duration || "isPause" !== d.data || d.ratio || 0 === d._startTime && 0 === o._rawPrevTime || (
                            l = d
                        ),
                        d = d._next;
            else 
                    for (d = o._last; d && d._startTime >= a && !l;) 
                        ...
                        d = d._prev;
            l && (o._time = o._totalTime = a = l._startTime, n = o._startTime + (
                    o._reversed
                        ? o._duration - a
                        : a
                ) / o._timeScale)
            ...
            if (o._time !== p && o._first || c || i || l) {
                            ...
                            d._reversed
                                ? d.render((
                                    d._dirty
                                        ? d.totalDuration()
                                        : d._totalDuration
                                ) - (a - d._startTime) * d._timeScale, b, c)
                ...
                h && (
                    o._gc || (r === o._startTime || s !== o._timeScale) && (0 === o._time || q >= o.totalDuration()) && (f && (
                        j.length && k(),
    ...
    _gsScope._gsDefine("TimelineMax", [
        ...
        k.tweenTo = function (a, c) {
            ...
            g.onStart = function () {
                ...
                f.vars.time === f
                    .target
                    .time() || d !== f.duration() || f.isFromTo || f
                    .duration(
                            Math.abs(f.vars.time - f.target.time()) / f.target._timeScale
                        )
                    .render(f.time(), !0, !0),
                c.onStart && c
                    .onStart
        ...
        k.render = function (a, b, c) {
            ...
            if (q !== p._time && (a += p._time - q), a >= r - e && a >= 0) 
                ...
                if (
                    ...
                    if (
                        p._rawPrevTime = s || !b || a || p._rawPrevTime === a
                            ? a
                            : e,
                        0 === a && f
                    ) 
                ...
                p._locked || (p._totalTime = a, 0 !== p._repeat && (
                    l = s + p._repeatDelay,
            ...
            if (p._hasPause && !p._forcingPlayhead && !b) {
                if (a = p._time, a > q || p._repeat && y !== p._cycle) 
                    for (d = p._first; d && d._startTime <= a && !m;) 
                        d._duration || "isPause" !== d.data || d.ratio || 0 === d._startTime && 0 === p._rawPrevTime || (
                            m = d
                        ),
                        d = d._next;
            else 
            ...
            m && (o = p._startTime + (
                    p._reversed
                        ? p._duration - m._startTime
                        : m._startTime
                ) / p._timeScale, m._startTime < s && (
            ...
            if (!(p._time !== q && p._first || c || k || m)) 
                return void(
                    t !== p._totalTime && p._onUpdate && (b || p._callback("onUpdate"))
                );
            if (
            ...
            j && (
                p._locked || p._gc || (u === p._startTime || v !== p._timeScale) && (0 === p._time || r >= p.totalDuration()) && (f && (
                    g.length && h(),
    ...
    function () {
        var a = 180 / Math.PI,
            ...
            h = ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,pad" +
                    "dingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPo" +
                    "sition_y,",
            i = function (a, b, c, d) {
                var e = {
                        a: a
            ...
            j = function (a, e, f, g, h) {
                ...
                for (j = 0; w > j; j++) 
                        ...
                        ? (t = b[j], u = c[j], v = (u + t) * e * .25 / (
                            ...
                            g
                                ...
                                : 0 !== u
                                    ? v / u
                                    : 0
                        ), q = l - (o + ((p - o) * (3 * t / (t + u) + .5) / 4 || 0)))
                        : (o = l - (l - k) * e * .5, p = l + (m - l) * e * .5, q = l - (o + p) / 2),
                    o += q,
                    p += q,
                    n.c = r = o,
                    0 !== j
                    ...
                    n.ba = y - k,
                    f
                        ? (s = i(k, y, r, l), a.splice(x, 1, s[0], s[1], s[2], s[3]), x += 4)
                        : x++,
                    y = p;
                n = a[x],
                n.b = y,
            ...
            k = function (a, d, e, f) {
                ...
                if (f) 
                    for (a = [f].concat(a), i = a.length; --i > -1;) 
                        "string" == typeof(m = a[i][d]) && "=" === m.charAt(1) && (
                            a[i][d] = f[d] + Number(
                                m.charAt(0) + m.substr(2)
                            )
                        );
            if (h = a.length - 2, 0 > h) 
            ...
            p = _gsScope
                ...
                .plugin({
                    ...
                    init: function (a, b, c) {
                        ...
                        this._mod = {},
                        this._props = [],
                        this._timeRes = null == b.timeResolution
                            ? 6
                        ...
                        for (f = this._props.length; --f > -1;) 
                            ...
                            h || j[d] !== i[0][d] && (h = j);
                        if (
                            this._beziers = "cubic" !== b.type && "quadratic" !== b.type && "soft" !== b.type
                                ? l(
                                    i,
                                    isNaN(b.curviness)
                                        ? 1
                        ...
                        if (n = this._autoRotate) 
                            for (
                                ...
                                for (g = 0; 3 > g; g++) 
                                    d = n[f][g],
                                    this._func[d] = "function" == typeof a[d]
                                        ? a[
                                            d.indexOf("set") || "function" != typeof a["get" + d.substr(3)]
                                                ? d
                                                : "get" + d.substr(3)
                    ...
                    set: function (b) {
                        ...
                        if (this._timeRes) {
                            ...
                            h = 1 === b
                                ? 1
                                : (e + (m - this._s1) / (this._s2 - this._s1)) * this._prec || 0
                        } else 
                            c = 0 > b
                                ? 0
                                : b >= 1
            ...
            if (a) {
                ...
                b._registerComplexSpecialProp("bezier", {
                    parser: function (a, b, f, g, h, i) {
                        ...
                        !q.autoRotate || q.autoRotate instanceof Array || (
                            j = q.autoRotate === !0
                                ? 0
                                : Number(q.autoRotate),
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", [
        ...
        var k,
            ...
            V = function () {
                var a = U.indexOf("Android"),
                    b = Q("a");
                return m = -1 !== U.indexOf("Safari") && -1 === U.indexOf("Chrome") && (
                    -1 === a || parseFloat(U.substr(
                        a + 8,
                        2
                    )) > 3
                ),
                ...
                (
                    /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(U) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(U)
                ...
                return V || "opacity" !== b
                    ? (
                        !d && a.style[b]
                            ? f = a.style[b]
                            : (c = c || aa(a))
                                ? f = c[b] || c.getPropertyValue(b) || c.getPropertyValue(
                                    b.replace(C, "-$1").toLowerCase()
                                )
                                : a.currentStyle && (f = a.currentStyle[b]),
                        null == e || f && "none" !== f && "auto" !== f && "auto auto" !== f
                            ? f
                            : e
                    )
                    : W(a)
            ...
            ca = T.convertToPixels = function (a, c, d, e, f) {
                ...
                if (n && (d = -d), o && (d *= 100), "lineHeight" !== c || e) 
                    if ("%" === e && -1 !== c.indexOf("border")) 
                        ...
                        if (
                            m.cssText = "border:0 solid red;position:" + ba(a, "position") + ";line-height:" +
                                    "0;",
            ...
            ja = function (a, b) {
                ...
                return null == f
                    ? f = "center" === e
                        ...
                        : "0"
                    : "center" === f && (f = "50%"),
                ("center" === e || isNaN(parseFloat(e)) && -1 === (e + "").indexOf("=")) && (
                    e = "50%"
                ),
                a = e + " " + f + (
                    d.length > 2
            ...
            la = function (a, b) {
                ...
                return "string" == typeof a && "v" === a.charAt(a.length - 2) && (a = (
                    c
                        ? a.substr(0, 2)
                        : 0
                ) + window["inner" + (
                ...
                null == a
                    ...
                    : "number" == typeof a
                        ...
                        : (e = 360, f = a.split("_"), i = "=" === a.charAt(1), g = (
                            i
                                ? parseInt(a.charAt(0) + "1", 10) * parseFloat(f[0].substr(2))
                                : parseFloat(f[0])
                        ) * (
                            -1 === a.indexOf("rad")
                                ? 1
        ...
        var sa = function (a, b, c, d) {
            ...
            xa = g.parseComplex = function (a, b, c, d, e, f, h, i, j, l) {
                ...
                e && ra.test(d + c) && (d = [
                    c, d
                ], g.colorStringFilter(d), c = d[0], d = d[1]);
                var m,
                    n,
                    o,
                    p,
                    ...
                    if (p = D[m], u = E[m] + "", x = parseFloat(p), x || 0 === x) 
                        ...
                        y && !V && 0 === u[3]
                            ...
                            : (
                                V || (y = !1),
                                C
                                    ? h.appendXtra(z.substr(0, z.indexOf("hsl")) + (
                                        y
                                            ? "hsla("
                                            : "hsl("
                                    ), p[0], ka(u[0], p[0]), ",", !1, !0).appendXtra(
                                        "",
                                        p[1],
                                        ka(u[1], p[1]),
                                        "%,",
                                    ...
                                    : h.appendXtra(z.substr(0, z.indexOf("rgb")) + (
                                        y
                                            ? "rgba("
                                            : "rgb("
                                    ), p[0], u[0] - p[0], ",", Math.round, !0).appendXtra(
                                        "",
                                        p[1],
                                        u[1] - p[1],
                                        ",",
                ...
                ? (
                    ...
                    h > 0
                        ? (
                            ...
                            g.rxp["xn" + h] = e,
                            g["xn" + h] = b,
                            g.plugin || (g.xfirst = new va(g, "xn" + h, b, c, g.xfirst || g, 0, g.n, e, g.pr), g.xfirst.xs0 = 0),
                            g
                        )
                        : (g.data = {
                            s: b + c
                        }, g.rxp = {}, g.s = b, g.c = c, g.r = e, g)
                )
                : (g["xs" + h] += b + (d || ""), g)
        };
        var za = function (a, b) {
        ...
        j.parseComplex = function (a, b, c, d, e, f) {
            ...
            if (this.multi && (
                J.test(c) || J.test(b)
                    ? (h = b.replace(J, "|").split("|"), i = c.replace(J, "|").split("|"))
                    : m && (h = [b], i = [c])
            ), i) {
                for (
                    j = i.length > h.length
                    ...
                    b = h[g] = h[g] || this.dflt,
                    c = i[g] = i[g] || this.dflt,
                    m && (k = b.indexOf(m), l = c.indexOf(m), k !== l && (
                        -1 === l
        ...
        var Ca,
            Da = (
                "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspectiv" +
                "e,xPercent,yPercent"
            ).split(","),
            Ea = $("transform"),
            Fa = Y + "transform",
            ...
            Ma = function () {
                ...
                return P.createElementNS && La.appendChild && !d && (
                    a = Ka("svg", La),
                    b = Ka("rect", a, {
                        width: 100,
                        height: 50,
            ...
            Ta = T.getTransform = function (a, c, d, e) {
                ...
                var f,
                    ...
                    l,
                    m = d
                        ? a._gsTransform || new Ia
                        : new Ia,
                    n = m.scaleX < 0,
                    o = 2e-5,
                    p = 1e5,
                    q = Ha
                        ? parseFloat(ba(a, Ga, c, !1, "0 0 0").split(" ")[2]) || m.zOrigin || 0
                        : 0,
                    r = parseFloat(g.defaultTransformPerspective) || 0;
                if (m.svg = !(!a.getCTM || !Qa(a)), m.svg && (
                    Na(a, ba(a, Ga, c, !1, "50% 50%") + "", m, a.getAttribute("data-svg-origin")),
                    ...
                    if (16 === f.length) {
                        ...
                        m.rotationX && Math.abs(m.rotationX) + Math.abs(m.rotation) > 359.9 && (
                    ...
                    Math.abs(m.skewX) > 90 && Math.abs(m.skewX) < 270 && (
                        n
                            ? (
                                m.scaleX *= -1,
                                m.skewX += m.rotation <= 0
                                    ? 180
                                    : -180,
                ...
                return d && (a._gsTransform = m, m.svg && (
                    Ca && a.style[Ea]
                        ? b.delayedCall(.001, function () {
                            Xa(a.style, Ea)
                        })
            ...
            Va = T.set3DTransformRatio = T.setTransformRatio = function (a) {
                    ...
                    return void(
                        B || P || K
                            ? (
                                ...
                                d = Math.sin(B - x) * -F,
                                g = Math.cos(B - x) * F,
                                x && "simple" === z.skewType && (b = Math.tan(x - O * L), b = Math.sqrt(
                                    1 + b * b
                                ), d *= b, g *= b, O && (b = Math.tan(O * L), b = Math.sqrt(1 + b * b), c *= b, f *= b)),
                                K && (
                                    H += z.xOrigin - (z.xOrigin * c + z.yOrigin * d) + z.xOffset,
                                    I += z.yOrigin - (z.xOrigin * f + z.yOrigin * g) + z.yOffset,
                                    Ca && (z.xPercent || z.yPercent) && (
                                        q = this.t.getBBox(),
                ...
                if (n && (
                    ...
                    P && (
                        ...
                        r = Math.cos(B),
                        s = Math.sin(B),
                        "simple" === z.skewType && (b = Math.tan((P - O) * L), b = Math.sqrt(
                            1 + b * b
                        ), r *= b, s *= b, z.skewY && (b = Math.tan(O * L), b = Math.sqrt(1 + b * b), c *= b, f *= b))
                    ),
                    d = -s,
                    g = r;
                else {
        ...
        Aa(
            "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotati" +
                    "onZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,tra" +
                    "nsformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform" +
                    ",force3D,skewType,xPercent,yPercent,smoothOrigin",
            {
                parser: function (a, b, c, d, f, h, i) {
                    if (d._lastParsedTransform === i) 
                        return f;
                    d._lastParsedTransform = i;
                    var j = i.scale && "function" == typeof i.scale
                        ? i.scale
                        : 0;
                    j && (i.scale = j(r, a));
                    var k,
                    ...
                    if (
                        ...
                        "string" == typeof z.x && -1 !== z
                            .x
                            .indexOf("%") && (k.x = 0, k.xPercent = la(z.x, C.xPercent)),
                        "string" == typeof z.y && -1 !== z
                            .y
                            .indexOf("%") && (k.y = 0, k.yPercent = la(z.y, C.yPercent)),
                        k.rotation = ma(
                            "rotation" in z
                                ? z.rotation
                                : "shortRotation" in z
                    ...
                    return D = "function" == typeof z.transformOrigin
                    ...
                    C.svg && (D || z.svgOrigin) && (
                        ...
                        f = wa(C, "xOrigin", (
                            v
                                ? C
                                : k
                        ).xOrigin, k.xOrigin, f, B),
                        f = wa(C, "yOrigin", (
                            v
                                ? C
                                : k
                        ).yOrigin, k.yOrigin, f, B),
                        (p !== C.xOffset || s !== C.yOffset) && (f = wa(
                            C,
                            "xOffset",
                            v
                                ? p
                    ...
                    n && (
                        d._transformType = C.svg && Ca || !m && 3 !== this._transformType
                            ? 2
                            : 3
                    ),
                    j && (i.scale = j),
                ...
                for (
                    ...
                    s !== t && (
                        ...
                        "%" === s
                            ? (m = v / q * 100 + "%", l = w / r * 100 + "%")
                            : "em" === s
                                ? (x = ca(a, "borderLeft", 1, "em"), m = v / x + "em", l = w / x + "em")
                                : (m = v + "px", l = w + "px"),
        ...
        Aa(
            "borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRi" +
                    "ghtRadius",
            {
                defaultValue: "0px",
        ...
        Aa("border", {
            ...
            parser: function (a, b, c, d, f, g) {
                ...
                this.parseComplex(a.style, this.format(
                    h + " " + ba(a, "borderTopStyle", e, !1, "solid") + " " + ba(a, "borderTopColor", e, !1, "#000")
                ), i.join(" "), f, g)
            },
            color: !0,
            formatter: function (a) {
        ...
        Aa("opacity,alpha,autoAlpha", {
            ...
            parser: function (a, b, c, d, f, g) {
                var h = parseFloat(ba(a, "opacity", e, !1, "1")),
                    i = a.style,
                    j = "autoAlpha" === c;
                return "string" == typeof b && "=" === b.charAt(1) && (b = (
                    "-" === b.charAt(0)
                        ? -1
                        : 1
                ) * parseFloat(b.substr(2)) + h),
                ...
                j && (f = new va(
                    ...
                    0 === b
                        ? "hidden"
                        : "inherit"
                ), f.xs0 = "inherit", d._overwriteProps.push(f.n), d._overwriteProps.push(c)),
                f
            }
        });
        var Xa = function (a, b) {
            ...
            Ya = function (a) {
                if (this.t._gsClassPT = this, 1 === a || 0 === a) {
                    ...
                    this
                        .t
                        .getAttribute("class") !== this.e && this
                        .t
            ...
            if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e) 
                    ...
                    for (b = this.e.split(" ").join("").split(","), d = b.length; --d > -1;) 
                        ...
                        Xa(g, c);
            e && (Xa(g, Ea), f = this.t._gsTransform, f && (
                ...
                for (
                    ...
                    Ea
                        ? m && (
                            ...
                            o && this._addLazySet(A, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (
                                y
                                    ? "visible"
                                    : "hidden"
                            ))
        ...
        j.parse = function (a, b, c, f) {
            ...
            for (g in b) {
                if (
                    ...
                    m = ba(a, g, e) + "",
                    s = "string" == typeof n,
                    "color" === g || "fill" === g || "stroke" === g || -1 !== g.indexOf("Color") || s && B.test(
                        n
                    )
                        ? (s || (n = pa(n), n = (
                            n.length > 3
                                ? "rgba("
                                : "rgb("
                        ) + n.join(",") + ")"), c = xa(u, g, m, n, !0, "transparent", c, 0, f))
                        : s && K.test(n)
                            ...
                            : (
                                ...
                                !j && 0 !== j || !l && 0 !== l
                                    ? void 0 !== u[g] && (n || n + "" != "NaN" && null != n)
                                        ? (
                                            c = new va(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n),
                                            c.xs0 = "none" !== n || "display" !== g && -1 === g.indexOf("Style")
                                                ? n
                                                : m
                                        )
                                        : X("invalid " + g + " tween value: " + b[g])
                                    : (
                                        c = new va(u, g, j, l - j, c, 0, g, k !== !1 && ("px" === p || "zIndex" === g), 0, m, n),
                                        c.xs0 = p
                                    )
                            )
                }
                        ...
                        if (
                            ...
                            if (1 === e.type) 
                                if (d = e.l, 2 === d) 
                                    ...
                                    e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3 + e.xn3 + e.xs4 + e.xn4 +
                                            e.xs5;
                                else {
        ...
        j._enableTransforms = function (a) {
            ...
            this._transformType = this._transform.svg && Ca || !a && 3 !== this._transformType
                ? 2
                : 3
        };
        var $a = function (a) {
            ...
            this
                .data
                ._linkCSSP(this, this._next, null, !0)
        };
        ...
        j._kill = function (b) {
            ...
            for (b.className && (c = this._classNamePT) && (
                e = c.xfirst,
                e && e._prev
                ...
                c.plugin && c.plugin !== d && c.plugin._kill && (
                    c.plugin._kill(b),
                    d = c.plugin
                ),
                c = c._next;
                    ...
                    "useRadians" !== e && (
                        ...
                        g = parseFloat(
                            "function" != typeof a[e]
                                ? a[e]
                                : a[
                                    e.indexOf("set") || "function" != typeof a["get" + e.substr(3)]
                                        ? e
                                        : "get" + e.substr(3)
                                ]()
                        ),
                        h = this.finals[e] = "string" == typeof f && "=" === f.charAt(1)
                            ? g + parseInt(f.charAt(0) + "1", 10) * Number(f.substr(2))
                            : Number(f) || 0,
                        i = h - g,
                        j.length && (
                            f = j.join("_"),
                            -1 !== f.indexOf("short") && (i %= k, i !== i % (k / 2) && (
                                i = 0 > i
                                    ? i + k
                                    : i - k
                            )),
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (a) {
        ...
        d = j("easing.RoughEase", function (b) {
            ...
            for (
                ...
                o = b.randomize !== !1,
                p = b.clamp === !0,
                q = b.template instanceof a
                    ? b.template
                    : null,
                r = "number" == typeof b.strength
                    ? .4 * b.strength
                    : .4; --m > -1;
            ) 
                c = o
        ...
        m(
            "Elastic",
            e("ElasticOut", function (a) {
                return this._p1 * Math.pow(2, -10 * a) * Math.sin((a - this._p3) * this._p2) + 1
            }, .3),
            e("ElasticIn", function (a) {
                return -(
                    this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * this._p2)
                )
            }, .3),
            e("ElasticInOut", function (a) {
                return (a *= 2) < 1
                    ? -.5 * (
                        this._p1 * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - this._p3) * this._p2)
                    )
...
function (a, b) {
    ...
    var g,
        ...
        q = function () {
            ...
            return function (c) {
                return null != c && (
                    c instanceof Array || "object" == typeof c && !!c.push && a.call(c) === b
                )
            }
        }(),
        r = {},
            ...
            this.check = function (j) {
                ...
                if (0 === q && g) {
                    if (
                        ...
                        n = m.pop(),
                        o = l(m.join("."))[n] = this.gsClass = g.apply(
                            g,
                            i
                        ),
                        h
    ...
    for (i = w.prototype, i._calcEnd = !1, i.getRatio = function (a) {
        ...
        y(new w(null, null, 2, h), i, "easeIn" + (
            0 === h
                ? ",easeNone"
                : ""
        )),
    ...
    u("Ticker", function (a, b) {
        ...
        i.useRAF = function (a) {
            return arguments.length
                ? (i.sleep(), m = a, void i.fps(c))
                : m
        },
        i.fps(a),
        setTimeout(function () {
            "auto" === m && i.frame < 5 && "hidden" !== (d || {}).visibilityState && i.useRAF(
                !1
            )
        }, 1500)
    }),
    ...
    i.time = function (a, b) {
        return arguments.length
            ? (this._dirty && this.totalDuration(), this.totalTime(
                a > this._duration
                    ? this._duration
                    : a,
                b
            ...
            if (
                ...
                if (a > d && !c && (a = d), this._startTime = (
                    ...
                    this._reversed
                        ? d - a
                        : a
                ) / this._timeScale, e._dirty || this._uncache(!1), e._timeline) 
                    for (; e._timeline;) 
                        e._timeline._time !== (e._startTime + e._totalTime) / e._timeScale && e.totalTime(
                            e._totalTime,
                            !0
                        ),
                        e = e._timeline
    ...
    i.timeScale = function (a) {
        ...
        var b,
            c;
        for (a = a || n, this._timeline && this._timeline.smoothChildTiming && (
            b = this._pauseTime,
            c = b || 0 === b
                ? b
                : this._timeline.totalTime(),
            this._startTime = c - (c - this._startTime) * this._timeScale / a
        ), this._timeScale = a, c = this.timeline; c && c.timeline;) 
            c._dirty = !0,
            c.totalDuration(),
            c = c.timeline;
        return this
    ...
    i.reversed = function (a) {
        return arguments.length
            ? (a != this._reversed && (this._reversed = a, this.totalTime(
                ...
                e._reversed
                    ? e.render((
                        e._dirty
                            ? e.totalDuration()
                            : e._totalDuration
                    ) - (a - e._startTime) * e._timeScale, b, c)
    ...
    var H = u("TweenLite", function (b, c, d) {
            ...
            this.target = b = "string" != typeof b
                ? b
                : H.selector(b) || b;
            var e,
                f,
                g,
                h = b.jquery || b.length && b !== a && b[0] && (
        ...
        J = function (a, b) {
            var c,
                d = {};
            for (c in a) 
                W[c] || c in b && "transform" !== c && "x" !== c && "y" !== c && "width" !== c && "height" !== c && "className" !== c && "border" !== c || !(
        ...
        O = function (a) {
            for (var b, c = this._firstPT, d = 1e-6; c;) 
                ...
                c.m
                    ? b = c
                        .m
                        .call(this._tween, b, this._target || c.t, this._tween)
                    : d > b && b > -d && !c.blob && (b = 0),
                c.f
                    ? c.fp
                        ? c.t[c.p](c.fp, b)
            ...
            for (f = e.length; --f > -1;) 
                (h = e[f]) === b || h._gc || h._paused || (
                    h._timeline !== b._timeline
                        ...
                        : h._startTime <= k && h._startTime + h.totalDuration() / h._timeScale > k && (
    ...
    i._initProps = function (b, c, d, e, f) {
        ...
        if (null == b) 
            return !1;
        L[b._gsTweenID] && _(),
        this.vars.css || b.style && b !== a && b.nodeType && T.css && this.vars.autoCSS !== !1 && J(
            this.vars,
            b
        );
        for (g in this.vars) 
            if (l = this.vars[g], W[g]) 
                l && (l instanceof Array || l.push && q(l)) && -1 !== l
                    .join("")
        ...
        return e && this._kill(e, b)
            ...
            : this._overwrite > 1 && this._firstPT && d.length > 1 && ca(
                b,
                this,
                c,
                this._overwrite,
                ...
                : (
                    this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (L[b._gsTweenID] = !0),
                    i
                )
    },
    i.render = function (a, b, c) {
        ...
        if (a >= j - n && a >= 0) 
            ...
            a > -n
                ? a = 0
                : 0 > a && (h._active = !1, 0 === j && (h._initted || !h.vars.lazy || c) && (
            ...
            if (!h._initted) {
                ...
                h._time && !d
                    ? h.ratio = h
                        ._ease
                        .getRatio(h._time / j)
                    : d && h._ease._calcEnd && (h.ratio = h._ease.getRatio(
                        0 === h._time
                            ? 0
                            : 1
                    ))
                ...
                for (f in j) 
                    (g = h[f]) && (m && (
                        g.f
                            ...
                            : g.t[g.p] = g.s,
                        i = !0
                    ), g.pg && g.t._kill(j) && (i = !0), g.pg && 0 !== g.t._overwriteProps.length || (
                        g._prev
    ...
    if (
        ...
        i._mod = i._roundProps = function (a) {
            for (var b, c = this._firstPT; c;) 
                b = a[this._propName] || null != c.n && a[
                    c
                        .n
                        .split(this._propName + "_")
                        .join("")
                ],
                b && "function" == typeof b && (
                    2 === c.f
